...
"""
    ...
    def __call__(self, instance) -> list[bool]:
        # NOTE: temperature=0.0 / max_tokens / logprobs are conditionally
        # dropped for reasoning-style models (gpt-5* / o*), which reject those
        # parameters and do not return logprobs. Selecting only reads the "[N]"
        # text from the reply, so logprobs were unused for this strategy anyway.
        # For non-reasoning chat models we keep the original ComEM behaviour.
        kwargs = {"seed": 42}
